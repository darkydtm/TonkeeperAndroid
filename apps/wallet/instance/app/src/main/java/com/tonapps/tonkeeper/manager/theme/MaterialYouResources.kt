	...
	fun apply(context: Context, palette: MaterialYouPalette): Boolean {
		...
		val colors = if (palette.dark) {
			mapOf(
				...
				ColorR.color.buttonGreenForegroundDark to scheme.buttonGreen.primaryForeground.toArgb(),
				...
				ColorR.color.buttonOrangeForegroundDark to scheme.buttonOrange.primaryForeground.toArgb(),
			...
			mapOf(
				...
				ColorR.color.buttonGreenForegroundLight to scheme.buttonGreen.primaryForeground.toArgb(),
				...
				ColorR.color.buttonOrangeForegroundLight to scheme.buttonOrange.primaryForeground.toArgb(),
